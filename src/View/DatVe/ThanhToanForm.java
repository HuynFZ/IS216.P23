    ...
    public ThanhToanForm(String maChuyen, String diemDi, String diemDen, String gioCatCanh, String gioHaCanh, int nguoiLon, int treEm, int emBe, String giaVe, JPanel mainJPanel, String loaiHinh, int tongSoKH, double tongGV, double thuePhi, double tongTien, String accId, List<UserHanhKhach> danhSachHanhKhach, double phiChoNgoi, double phiHanhLy, double phiSuatAn, double phiBaoHiem, double tongPhiDichVu) throws SQLException, ClassNotFoundException {
        ...
        lblTheTinDung.addMouseListener(new java.awt .event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt){
                ...
                try {
                    new TheTinDung(mainPanel, maChuyen, diemDi, diemDen, gioCatCanh, gioHaCanh, nguoiLon, treEm, emBe, giaVe, loaiHinh, tongSoKH, tongGV, thuePhi, tongTienSauCung, danhSachHanhKhach, maKhuyenMai, accId, diemThuong, tongTienDiemTV, tienGiam, tongTien, tongPhiDichVu, phiChoNgoi, phiHanhLy, phiBaoHiem, phiSuatAn).setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ThanhToanForm.class.getName()).log(Level.SEVERE, null, ex);
        ...
        nganHang.addMouseListener(new java.awt .event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt){
                ...
                String diemThuong = txtDiem.getText();
                try {
                    new ThanhToanNganHang(mainPanel, maChuyen, diemDi, diemDen, gioCatCanh, gioHaCanh, nguoiLon, treEm, emBe, giaVe, loaiHinh, tongSoKH, tongGV, thuePhi, tongTienSauCung, danhSachHanhKhach, maKhuyenMai, accId, diemThuong, tongTienDiemTV, tienGiam, tongTien, tongPhiDichVu, phiChoNgoi, phiHanhLy, phiBaoHiem, phiSuatAn).setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ThanhToanForm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        viMoMo.addMouseListener(new java.awt .event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt){
                ...
                String diemThuong = txtDiem.getText();
                try {
                    new ThanhToanMoMo(mainPanel, maChuyen, diemDi, diemDen, gioCatCanh, gioHaCanh, nguoiLon, treEm, emBe, giaVe, loaiHinh, tongSoKH, tongGV, thuePhi, tongTienSauCung, danhSachHanhKhach, maKhuyenMai, accId, diemThuong, tongTienDiemTV, tienGiam, tongTien, tongPhiDichVu, phiChoNgoi, phiHanhLy, phiBaoHiem, phiSuatAn).setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ThanhToanForm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
