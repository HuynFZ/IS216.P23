...
public class ThanhToanMoMoKhungGio extends javax.swing.JFrame {
    ...
    public ThanhToanMoMoKhungGio(JPanel mainJPanel, String diemDi, String diemDen, int nguoiLon, int treEm, int emBe,int tongSoKH,double tongTienSauCung, List<UserHanhKhach> danhSachHanhKhach, String accId, double tongPhiDV, double phiBaoHiem, double phiSuatAn) throws  ClassNotFoundException {
        initComponents();
        ...
        btnXacNhanTT.addActionListener(e -> {
            ...
            try {
                ...
                Logger.getLogger(ThanhToanMoMoKhungGio.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel21.setText("THANH TOÁN QUA MOMO");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/ttmomo.jpg"))); // NOI18N
...
//            }
//        } catch (ClassNotFoundException ex) {
//            java.util.logging.Logger.getLogger(ThanhToanMoMo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ThanhToanMoMo().setVisible(true);
//            }
//        });
//    }
